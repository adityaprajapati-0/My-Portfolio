...
const SOCIAL_LINKS = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/aditya-prajapati-428a02297/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/adityaprajapati-0',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
    ...
    <footer className="footer-section">
      <div className="footer-container">
        ...
        <p className="footer-copy">
          © {new Date().getFullYear()} Aditya Prajapati. Built with ❤️
        </p>
      </div>
    </footer>
  );
